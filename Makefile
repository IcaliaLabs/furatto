...
build:
	...
	@cat js/snap.js js/panel.js js/jquery.toolbar.js js/toolbar.js js/rainbow-custom.min.js js/tooltip.js js/picker.js js/picker.date.js js/legacy.js js/responsive-tables.js js/dropdown.js js/modal.js js/idangerous.swiper-2.1.js js/nav.js js/modernizr.custom.js js/manifest.js > js/furatto.js
