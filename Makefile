...
build:
	...
	@cat js/dropdown.js js/jpanel.js js/jquery.dropkick-1.0.0.js js/jquery.icheck.js js/jquery.tagsinput.js js/jquery.toolbar.js js/legacy.js js/picker.js js/picker.date.js js/picker.time.js js/rainbow-custom.min.js js/responsive-tables.js js/responsiveslides.js js/tooltip.js > js/furatto.js
