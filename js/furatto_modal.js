...
(function($, window) {
  ...
  Modal = (function() {
    ...
    Modal.prototype.toggle = function() {
      return this[(!this.isShown ? this.activate() : this.deactivate())];
    };
    ...
    Modal.prototype.activate = function() {
      ...
      this.body.append("<div class='avgrund-popin'>" + (this.$el.html()) + "</div>");
  ...
  $.fn.extend({
    modal: function() {
      ...
      return this.each(function() {
        ...
        return $('body').append('<div class="avgrund-overlay"></div>');
      });
    }
  });
